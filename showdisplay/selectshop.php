      ...
      <div class="row">
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0" style="background-color: #24282d">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-3 mb-2" style="text-align: left">
               <div class="text-white text-center p-3"
                    style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); background-color: #24282d"><img src="../images/icon/shop.png" width="25px" height="25px"/> : </div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6 mb-4" style="text-align: left">
               <div class="rounded text-white text-center p-3"
                    style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); background-color: #24282d" data-toggle="modal" data-target="#selectshop">+ เพิ่มร้านค้า</div>
              </div>

              <div class="col-lg-3 col-md-3 col-sm-3 mb-4" style="text-align: right">
                <div class="text-white text-center p-3"
                     style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); background-color: #24282d"><img src="../images/icon/device.png" width="23px" height="25px"/> :</div>
              </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                <div class="card card-small">
                  ...
                  <div class="card-body pt-0">
                    <div class="row border-bottom py-2" style="background-color: #24282d">
                      <!-- <div class="bg-success rounded text-white text-center p-2" style="width: 200px"
                      style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ รูปเเบบที่กำลังเเสดง</div> -->
                      <span style="margin-left: 20px; color: #eeeeee">
                        <img src="../images/icon/shop.png" width="25px" height="25px"/> &nbsp;
                         <span>ร้านค้าของคุณ</span>
                  </div>
                </div>
                <div class="card-header border-bottom">
                  <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                    ...
                    <?php
                      ...
                      $i = 0;while ($resultshop = mysqli_fetch_array($queryshop, MYSQLI_ASSOC)){

                    ?>

                    <div class="col-lg-3 col-md-3 col-sm-12">

                    <div class="card" style="width: 18rem; background-color: #24282d;">

                        <img class="card-img-top" src="../images/icon/192x192.png" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title" style="color: #eeeeee"><?php echo $resultshop["shop_name"]; ?></h5>
                          <p class="card-text" style="color: #eeeeee"><?php echo $resultshop["shop_detail"]; ?></p>
                          <a href="#" class="btn" style="background-color: #eeeeee">
                            <span style="color: #24282d">เลือกร้านนี้</span></a>
                        </div>
...
                  </div>
              ...
              <div class="card-header border-bottom"  style="background-color: #24282d">
                  <!--  -->
              </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #24282d">
            <h6 class="modal-title" id="exampleModalLabel" style="color: #eeeeee">เพิ่มร้านค้า</h6>
          ...
          <div class="modal-body">
            <div class="row">
               <div class="col-lg-12 col-md-12 col-sm-12 mb-4" style="text-align: center">

                 <form action="../php/insert_shop.php" method="post">

                         <strong class="d-block mb-2" style="color: #24282d">ชื่อร้าน</strong>
                         <input type="text" class="form-control" id="upload_name" name="upload_name"
                         style="width: 100%; height: 40px; border-color: #24282d"/> </br>

                         <strong class="d-block mb-2" style="color: #24282d">รายละเอียดร้านค้า</strong>
                         <input type="text" class="form-control" id="upload_detail" name="upload_detail"
                         style="width: 100%; height: 144px; border-color: #24282d"/> </br>

                         <strong class="d-block mb-2" style="color: #24282d">ที่อยู่</strong>
                         <input type="text" class="form-control" id="upload_address" name="upload_address"
                         style="width: 100%; height: 144px; border-color: #24282d"/> </br>

                         <strong class="d-block mb-2" style="color: #24282d">ตำบล</strong>
                         <input type="text" class="form-control" id="upload_sdistrict" name="upload_sdistrict"
                         style="width: 100%; height: 40px; border-color: #24282d"/> </br>

                         <strong class="d-block mb-2" style="color: #24282d">อำเภอ</strong>
                         <input type="text" class="form-control" id="upload_district" name="upload_district"
                         style="width: 100%; height: 40px; border-color: #24282d"/> </br>

                         <strong class="d-block mb-2" style="color: #24282d">จังหวัด</strong>
                         <input type="text" class="form-control" id="upload_province" name="upload_province"
                         style="width: 100%; height: 40px; border-color: #24282d"/> </br>

                         <strong class="d-block mb-2" style="color: #24282d">เบอร์โทร</strong>
                         <input type="text" class="form-control" id="upload_tel" name="upload_tel"
                         style="width: 100%; height: 40px; border-color: #24282d"/> </br>

                         <input type="text" class="form-control" id="upload_user_id" name="upload_user_id"
                         value="1"
                         style="width: 100%; height: 40px; border-color: #24282d"/> </br>
        ...
        <div class="modal-footer" style="margin-top: 0px; text-align: right; padding-right: 30px; background-color: #24282d">
