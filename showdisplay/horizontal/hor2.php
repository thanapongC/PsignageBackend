              ...
              <div class="card card-small">
                ...
                <div class="card-body pt-0">
                  <div class="row border-bottom py-2 bg-light">
                    <div class="bg-success rounded text-white text-center p-2" style="width: 200px" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ รูปเเบบที่ 2</div>
                  </div>
                </div>
                    ...
                    <div class="cotainer">
                      ...
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-7" style="margin-top: 0px; margin-right: 0px; background-color: red; ">
