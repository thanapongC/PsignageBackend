              ...
              <div class="card card-small">
                ...
                <div class="card-body pt-0">
                  <div class="row border-bottom py-2 bg-light">
                    <div class="bg-success rounded text-white text-center p-2" style="width: 200px" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ รูปเเบบที่ 1</div>
                  </div>
                </div>
                    ...
                    <div class="cotainer">
                      ...
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-3 col-md-3 col-sm-3 col-3" style="margin-top: 0px; margin-right: 0px; background-color: red; ">
                          ...
                          <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-9 col-9" style="margin-top: 0px; margin-right: 0px; background-color: green; ">

                                <div class="row">

                                  <div class="col-6">

                                    <input type="text" class="form-control" id="videoname" style="margin-top: 20px">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-3" style="margin-top: 0px; margin-right: 0px; background-color: pink; ">
