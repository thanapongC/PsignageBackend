              ...
              <div class="card card-small">
                ...
                <div class="card-body pt-0">
                  <div class="row border-bottom py-2 bg-light">
                    <div class="bg-success rounded text-white text-center p-2" style="width: 200px" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ รูปเเบบเเนวตั้งทั้งหมด</div>
                  </div>
                </div>
                <div class="card-header border-bottom" style="text-align: center">
                  <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-md-12 col-sm-12 mb-4" style="text-align: center; padding-left: 0">
                        <a href="vertical/ver1.html">
                      <img src="../images/pic/vertical/ver1.png" height="390" />
                      </a>
                      </div>
                      <div class="col-lg-3 col-md-12 col-sm-12 mb-4" style="text-align: center; padding-left: 0">
                        <a href="vertical/ver2.html">
                      <img src="../images/pic/vertical/ver2.png" height="390" />
                      </a>
                      </div>
                      <div class="col-lg-3 col-md-12 col-sm-12 mb-4" style="text-align: center; padding-left: 0">
                        <a href="vertical/ver3.html">
                      <img src="../images/pic/vertical/ver3.png" height="390" />
                      </a>
                      </div>
                      <div class="col-lg-3 col-md-12 col-sm-12 mb-4" style="text-align: center; padding-left: 0">
                        <a href="vertical/ver4.html">
                      <img src="../images/pic/vertical/ver4.png" height="390" />
                      </a>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-3 col-md-12 col-sm-12 mb-4" style="text-align: center; padding-left: 0">
                        <a href="vertical/ver5.html">
                      <img src="../images/pic/vertical/ver5.png" height="390" />
                      </a>
                      </div>
                      <div class="col-lg-3 col-md-12 col-sm-12 mb-4" style="text-align: center; padding-left: 0">
