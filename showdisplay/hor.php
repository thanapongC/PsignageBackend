              ...
              <div class="card card-small">
                ...
                <div class="card-body pt-0">
                  <div class="row border-bottom py-2 bg-light">
                    <div class="bg-success rounded text-white text-center p-2" style="width: 200px" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ รูปเเบบเเนวนอนทั้งหมด</div>
                  </div>
                </div>
                <div class="card-header border-bottom">
                  <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-8 col-sm-8 mb-4" style="text-align: center; padding-left: 0">
                        <a href="horizontal/hor1.html">
                        <img src="../images/pic/horizontal/hor1.png" width="60%" />
                        </a>
                      </div>
                      <div class="col-lg-4 col-md-8 col-sm-8 mb-4" style="text-align: center; padding-left: 0">
                        <a href="horizontal/hor2.html">
                        <img src="../images/pic/horizontal/hor2.png" width="60%" />
                        </a>
                      </div>
                      <div class="col-lg-4 col-md-8 col-sm-8 mb-4" style="text-align: center; padding-left: 0">
                        <a href="horizontal/hor3.html">
                        <img src="../images/pic/horizontal/hor3.png" width="60%" />
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-8 col-sm-8 mb-4" style="text-align: center; padding-left: 0">
                        <a href="horizontal/hor4.html">
                        <img src="../images/pic/horizontal/hor4.png" width="60%" />
                        </a>
                      </div>
                      <div class="col-lg-4 col-md-8 col-sm-8 mb-4" style="text-align: center; padding-left: 0">
                        <a href="horizontal/hor5.html">
                        <img src="../images/pic/horizontal/hor5.png" width="60%" />
                        </a>
                      </div>
                      <div class="col-lg-4 col-md-8 col-sm-8 mb-4" style="text-align: center; padding-left: 0">
