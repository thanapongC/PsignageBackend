        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="row">
            <div class="col-lg col-md-4 col-sm-12 mb-4">
              <div class="bg-success rounded text-white text-center p-3" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);" data-toggle="modal" data-target="#addvideo">+ เพิ่มเว็บไซต์</div>
            </div>
          </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
              <div class="card card-small">
                <div class="card-header border-bottom">
                  <h6 class="m-0">เว็บไซต์ทั้งหมด</h6>
                </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">เพิ่มเว็บไซต์ใหม่</h5>
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                          <form action="" method="post" enctype="multipart/form-data">
                            <input type="text"  class="form-control" id="upload_file" name="upload_file" style="width: 100%; height: 40px"/>
                        </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                            <label for="videoname">ชื่อเว็บไซต์</label>
