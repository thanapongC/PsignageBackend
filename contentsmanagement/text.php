        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="row">
            <div class="col-lg col-md-4 col-sm-12 mb-4">
              <div class="bg-success rounded text-white text-center p-3" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);" data-toggle="modal" data-target="#addtext">+ เพิ่มข้อความ</div>
            </div>
          </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
              <div class="card card-small">
                <div class="card-header border-bottom">
                  <h6 class="m-0">ข้อความทั้งหมด</h6>
                </div>
                ...
                <div class="modal-dialog" role="document">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">เพิ่มข้อความใหม่</h5>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                            <input type="text" class="form-control" id="text_content" name="text_content" style="width: 100%; height: 40px"/>
                        </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                            <label for="textname">ชื่อข้อความ</label>
