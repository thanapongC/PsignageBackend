        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="row">
            <div class="col-lg col-md-4 col-sm-12 mb-4">
              <div class="bg-success rounded text-white text-center p-3" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2);" data-toggle="modal" data-target="#addvideo">+ เพิ่มรุปภาพใหม่</div>
            </div>
          </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">เพิ่มรูปภาพใหม่</h5>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                            <label for="videoname">ชื่อรูปภาพ</label>
