              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                <div class="card card-small">
                  ...
                  <div class="card-body pt-0">
                    <div class="row border-bottom py-2 bg-light">
                      <div class="bg-success rounded text-white text-center p-2"
                      style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ สถานะการเชื่อมต่อ</div>
                  </div>
                </div>
                <div class="card-header border-bottom">
                  <div class="custom-control custom-toggle custom-toggle-sm mb-1">
                    <div class="checkbox">
                      <lable>
                      <input id="connectstatus" type="checkbox" checked data-toggle="toggle">
                    </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body pt-0">
                  <div class="row border-bottom py-2 bg-light">
                    <div class="bg-success rounded text-white text-center p-2"
                    style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ รายละเอียดอุปกรณ์</div>
                </div>
              </div>
              <div class="card-header border-bottom">
                  <strong class="text-muted d-block mb-2">ชื่ออุปกรณ์ : </strong>
                  <strong class="text-muted d-block mb-2">พื้นที่ว่างที่จัดเก็บข้อมูล : </strong>
                  <strong class="text-muted d-block mb-2">Ram : </strong>
                  <strong class="text-muted d-block mb-2">เวอร์ชั่นของอุปกรณ์ : </strong>
              </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">เพิ่มวีดีโอใหม่</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                          <label for="videoname">ชื่อวีดีโอ</label>
