              ...
              <div class="card card-small">
                ...
                <div class="card-body pt-0">
                  <div class="row border-bottom py-2 bg-light">
                    <div class="bg-success rounded text-white text-center p-2" style="box-shadow: inset 0 0 5px rgba(0,0,0,.2); margin-left: 10px;">+ เปลี่ยนรหัสผ่าน</div>
                  </div>
                </div>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                          <strong class="text-muted d-block mb-2">รหัสผ่านเก่า</strong>
                          <input type="text" class="form-control" id="upload_name" name="upload_name" style="width: 100%; height: 40px;"/> </br>
                          <strong class="text-muted d-block mb-2">รหัสผ่านใหม่</strong>
                          <input type="text" class="form-control" id="upload_address" name="upload_address" style="width: 100%; height: 40px;"/> </br>
                          <strong class="text-muted d-block mb-2">ยืนยันรหัสผ่าน</strong>
                          <input type="text" class="form-control" id="upload_province" name="upload_province" style="width: 100%; height: 40px;"/> </br>
                        </div>
                      </div>

                      <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="margin-top: 0px; text-align: right; padding-right: 30px;">
